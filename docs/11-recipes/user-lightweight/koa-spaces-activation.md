...
- every manifest and interface asset has passed artifact admission;
...
5. Resolve every route, sidebar item, widget action, icon, localization resource, and page reference.
...
8. Simulate online and offline composition and verify that every route and widget has a declared state.
...
- the current Space remains understandable without remote assets;
