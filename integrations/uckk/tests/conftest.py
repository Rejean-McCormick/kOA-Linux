...
from koa_uckk_adapter.learning_import import (  # noqa: E402
    ImportAction,
    ImportPolicy,
    ImportRequest,
...
from koa_uckk_adapter.mediatheque_frame import (  # noqa: E402
    FrameMappingPolicy,
    FrameProjector,
)
from koa_uckk_adapter.package_verification import (  # noqa: E402
    PackageVerifier,
    SourceEvidence,
)
...
class SourcePort:
    def __init__(
        ...
        *,
        ...
        equivalent_verified: bool = False,
    ...
    def verify(self, package: Mapping[str, Any], *, transport_kind: Any) -> SourceEvidence:
        ...
        return SourceEvidence(
            ...
            self.equivalent_verified,
            ("evidence:uckk-source-001",),
        )
    ...
    def verify(
        ...
        *,
        ...
        return bool(
            ...
            and len(data) == size_bytes
            and __import__("hashlib").new(algorithm, data).hexdigest() == digest
        )
...
class GovernancePort:
    ...
    def evaluate_import(self, **request: Any) -> LocalPolicyDecision:
        ...
        return LocalPolicyDecision(
            ...
            decision_ref="decision:governance:uckk-import-001",
            reason_code=(
                "LOCAL_IMPORT_ALLOWED"
                if self.outcome is PolicyOutcome.ALLOW
                else "LOCAL_IMPORT_REVIEW_REQUIRED"
                if self.outcome is PolicyOutcome.REVIEW
                else "LOCAL_IMPORT_DENIED"
            ),
            evidence_refs=("evidence:governance-001",),
...
class MediathequePort:
    def __init__(self, events: list[str]) -> None:
        ...
        self.accept_response: dict[str, Any] = {
            "outcome": "accepted",
            "reason_code": "LOCAL_IDENTITIES_CREATED",
            "local_record_refs": ["koa_media_import_001"],
            "local_version_refs": ["koa_media_version_import_001"],
            "evidence_refs": ["receipt:mediatheque-accept-001"],
        }
        self.update_response: dict[str, Any] = {
            "outcome": "update_candidate",
            "conflict_state": "local_changes_present",
            "evidence_refs": ["receipt:mediatheque-update-001"],
        }
...
def valid_package() -> dict[str, Any]:
    frame = {
        "$schema": "https://schemas.koa.local/artifact-contracts/shared-mediatheque-frame.schema.json",
        "frame_id": "koa-uckk-shared-mediatheque-frame",
        "frame_version": "1.0.0",
        "object_identity": {
            "authority_domain_id": SOURCE_AUTHORITY,
            "object_id": "uckk:object:course-001",
            "origin_system": "uckk",
            "external_refs": ["moodle:course:001"],
        },
        "version_identity": {
            "version_id": "uckk:version:course-001:v1",
            "created_at": "2026-08-01T12:00:00Z",
            "source_version_ref": "moodle:course:001:v1",
        },
        "integrity": {"algorithm": "sha256", "digest": DIGEST},
        "media": {
            "media_type": "text/plain",
            "title": "Offline learning resource",
        ...
        "rights": {
            ...
            "license_ref": "license:cc-by-4.0",
            "disclosure_status": "organization_private",
            "restriction_refs": ["restriction:no-public-redistribution"],
        },
        "provenance": {
            "source_system": "uckk",
            "source_object_ref": "uckk:object:course-001",
            "source_version_ref": "uckk:version:course-001:v1",
            "acquisition_method": "imported_online",
            "acquired_at": "2026-08-01T12:00:00Z",
            "receipt_refs": ["uckk:export-receipt:001"],
        },
        "lifecycle": {
            "state": "active",
            "authority_domain_id": SOURCE_AUTHORITY,
    ...
    return {
        "$schema": "https://schemas.koa.local/artifact-contracts/uckk-learning-package.schema.json",
        "package_id": "uckk_learning_package_contract_001",
        ...
        "source": {
            ...
            "site_ref": "moodle-site:primary",
            "publisher_identity_ref": "identity:uckk-publisher",
            "signature_ref": "signature:uckk-package-001",
        },
        "selection": {
            "selection_type": "course",
            "source_object_refs": ["uckk:object:course-001"],
            "source_version_refs": ["uckk:version:course-001:v1"],
            "requested_by_ref": "identity:user-001",
        },
        "frame_compatibility": {
            "frame_id": "koa-uckk-shared-mediatheque-frame",
            "source_frame_version": "1.0.0",
        ...
        "learning_structure": {
            "structure_type": "moodle_course",
            "root_ref": "uckk:object:course-001",
            "offline_runtime_requirements": ["static_content_renderer"],
            "activity_count": 1,
        },
        "resources": [
            {
        ...
        "manifest": {
            ...
            "entry_count": 1,
            "complete": True,
            "signature_refs": ["signature:uckk-package-001"],
        },
        "rights": {
            "license_status": "declared",
            "license_ref": "license:cc-by-4.0",
        ...
        "provenance": {
            ...
            "export_receipt_refs": ["uckk:export-receipt:001"],
            "publisher_statement_ref": "statement:uckk-publisher-001",
        },
    }


@pytest.fixture
def import_request(valid_package: dict[str, Any]) -> ImportRequest:
    return ImportRequest(
        request_id="uckk-import-attempt-001",
        package_id=valid_package["package_id"],
        idempotency_key="idem:uckk:import:001",
        correlation_id="corr:uckk:import:001",
        actor_ref="identity:user-001",
        authority_domain_id=LOCAL_AUTHORITY,
        endpoint_id="uckk-primary",
        selection_type="course",
        source_object_refs=("uckk:object:course-001",),
        source_version_refs=("uckk:version:course-001:v1",),
        action=ImportAction.REQUEST_ACCEPTANCE,
    )


@pytest.fixture
def offline_bundle() -> dict[str, Any]:
    return {"bundle_id": "offline_bundle_001", "package_refs": ["uckk_learning_package_contract_001"]}
...
def make_service(
    ...
    *,
    ...
    malware_outcome: str = "pass",
    source_verified: bool = True,
    signature_verified: bool = True,
    offline_bundle_valid: bool = True,
    policy_outcome: PolicyOutcome = PolicyOutcome.ALLOW,
) -> tuple[LearningImportService, dict[str, Any]]:
    events: list[str] = []
    ...
    projector = FrameProjector(
        FrameMappingPolicy(
            local_authority_domain_id=LOCAL_AUTHORITY,
            target_frame_version="1.0.0",
            supported_source_versions=("1.0.0",),
            supported_mapping_versions=("1.0.0",),
        )
    )
    verifier = PackageVerifier(
        schema=SchemaPort("uckk-learning-package.schema.json"),
        manifest=ManifestPort(manifest_valid, events),
        source_evidence=SourcePort(
            source_verified=source_verified,
            signature_verified=signature_verified,
            events=events,
        ),
        resource_integrity=IntegrityPort(
            {CONTENT_REF: CONTENT}, valid=integrity_valid, events=events
        ),
        malware=MalwarePort(malware_outcome, events),
        frame_projector=projector,
        offline_bundle=OfflineBundlePort(offline_bundle_valid, events),
    )
    service = LearningImportService(
        ...
        clock=FixedClock(),
        ids=SequenceIds(),
        policy=ImportPolicy(("uckk-primary",), maximum_resource_count=100),
    )
    return service, {
        "events": events,
        "client": client,
