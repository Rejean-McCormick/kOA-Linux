#!/usr/bin/env python3
"""Run the contract CI gate and emit deterministic candidate evidence."""
...
DEFAULT_PATHS = ['tests/contracts/test_schema_validation.py', 'tests/contracts/test_generated_bindings.py', 'tests/contracts/test_component_contracts.py', 'tests/contracts/test_subsystem_contracts.py', 'tests/contracts/test_profile_contracts.py', 'tests/contracts/test_release_contracts.py']
DEFAULT_COMMANDS = [['{python}', 'docs/tools/check_artifact_contracts.py'], ['{python}', 'docs/tools/check_release_sets.py']]
DEFAULT_POLICY = ''
