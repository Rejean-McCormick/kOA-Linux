#!/usr/bin/env python3
"""Run the component CI gate and emit deterministic candidate evidence."""
...
DEFAULT_PATHS = ['components', 'integrations']
DEFAULT_COMMANDS = [['{python}', 'docs/tools/check_component_boundaries.py']]
DEFAULT_POLICY = ''
